...
void Upgrade::update(double t, Xbox360Controller &controller, sf::Time dt)
{
	...
	if (button_ID == 0)
	{
		...
		whiteCar_values[0] = 110 + whiteCar_status[0] * 15;
	...
	else if (button_ID == 1)
	{
		...
		reaCar_values[0] = 100 + redCar_status[0] * 18;
	...
	else if (button_ID == 2)
	{
		...
		yellowCar_values[0] = 105 + yellowCar_status[0] * 12;
	...
	else if (button_ID == 3)
	{
		...
		greenCar_values[0] = 108 + greenCar_status[0] * 15;
